...
#SBATCH --job-name=rickerRerunA_minmax
#SBATCH --array=1-30
...
config=Model_Runs/poiss_Sim_mods/RickerConfigA_MinMaxMiss.txt
...
Rscript Model_Runs/poiss_Sim_mods/modelruns_ricker_DA.R ${datFile} ${parFile} ${clsize} ${saveFile} ${index1} ${index2} > Model_Runs/poiss_Sim_mods/outputRickerA_${SLURM_ARRAY_TASK_ID}.txt
