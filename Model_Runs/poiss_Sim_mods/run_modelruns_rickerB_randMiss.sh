...
#SBATCH --job-name=rickerRerunB_randMiss
#SBATCH --array=1-30
...
config=Model_Runs/poiss_Sim_mods/RickerConfigB_randMiss.txt
...
Rscript Model_Runs/poiss_Sim_mods/modelruns_ricker.R ${datFile} ${parFile} ${clsize} ${saveFile} ${index1} ${index2} > Model_Runs/poiss_Sim_mods/outputRickerB_randMiss${SLURM_ARRAY_TASK_ID}.txt
