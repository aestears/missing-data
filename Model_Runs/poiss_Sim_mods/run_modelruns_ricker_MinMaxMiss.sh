...
Rscript Model_Runs/poiss_Sim_mods/modelruns_ricker.R ${datFile} ${parFile} ${clsize} ${saveFile} ${index1} ${index2} > Model_Runs/poiss_Sim_mods/outputRickerMinMaxMiss_${SLURM_ARRAY_TASK_ID}.txt
